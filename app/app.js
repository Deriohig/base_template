...
// Animation text
var prefix = "Hey there, Im Deri and I ";
var skills = [
  "write simple, reusable code.",
  "love React.",
  "am an expert at Javascript, HTML and CSS.",
  "am an enterprise design thinker.",
  "love to teach and learn.",
  "am fond of a bit of 🍽 and 🍷.",
  "am seeking a good challenge.",
].map(function (s) {
  return s + ".";
});
var delay = 2;
...
var Doggo = {
  ...
  getDoggo: function (ID) {
    ...
    Doggo.load(doggoUrl, function (xhr) {
      ...
      if (
        response.data.images[0].link === null ||
        response.data.images[0].link === undefined
      ) {
        componentTwo.style.display = "none";
        return;
      }
...
elements.forEach(function (elem, index) {
  ...
  if (
    elem.href.substr(elem.href.lastIndexOf("/") + 1) == pgurl ||
    elem.href == ""
  ) {
  ...
  if (points && points.length) {
    points.map(function (point, index) {
      ...
      let mapItem =
        ...
        point.yAxis +
        "%;' ></a> " +
        "<div class='info-block col-lg-4 col-md-4 " +
        flip +
        "' data-attr='" +
        source +
        "-point-" +
        ...
        active +
        "' > " +
        " <div class='close-btn'><i class='close rounded'></i></div> <div class='text-area'> <h4> " +
        point.title +
        " </h4> <p class='p-14 bold text-brand-primary'>" +
        point.message +
        "</p></div></div>";
    ...
    document
      .querySelectorAll(".component-map-banner .info-block")
      .forEach(function (elem, index) {
        ...
        let selector =
          ".component-map-banner a.location[data-attr='" + dataInfo + "']";
        ...
        anchor.addEventListener("click", function (event) {
          ...
          document
            .querySelectorAll(".component-map-banner a.location")
            .forEach(function (elem) {
...
if (document.getElementsByClassName("component-map-banner")) {
  const mapPoints = {
    home: [
      {
        ...
        yAxis: "80",
        message:
          "I grew up a screw up, got introdued to the game - got an ounce. I blew up. Fat stacks overnight, young brother biggie smalls gonna be the next Frank White.",
      },
      {
        title: "title",
        xAxis: "95.5",
    ...
    creditUnion: [
      ...
      },
      {
        ...
        yAxis: "30",
        message:
          "The Credit Union framework uses parallax on the majority of its images.",
      },
      {
        ...
        yAxis: "50.5",
        message:
          "Everything is built as a component, meaning it is reusable in the backend of the sites. All you need to do is simply pick a component, and fill in the relevent information such as text, icons, and button links. ",
      },
      {
        ...
        yAxis: "68.5",
        message:
          "The layout for the credit unions are clear and concise. A professional apearance with a bit of style, it is clean and understated.",
      },
    ],
    dpdLocator: [
      {
        ...
        yAxis: "6",
        message:
          "The locator has both a list view and a map view. The list view enables a more detailed breakdown of the close locations, while the map view enables a broader search.",
      },
      {
        title: "Filtering",
        xAxis: "21",
        yAxis: "8",
        message:
          "DPD needed to be able to filter their locations by a number of criteria. Opening times, opening days, location types, location accessability and services, ",
      },
      {
        ...
        yAxis: "69",
        message:
          "All locations come with information layouts that can be used within search and filter terms",
      },
      {
        ...
        yAxis: "21.5",
        message:
          "Customisable locations markers change depending on the location type.",
      },
    ],
    merlynLocator: [
      {
        ...
        yAxis: "35.5",
        message:
          "When there are more than one location in the viewable area, locations cluster together using the Marker Clusterer API",
      },
      {
        ...
        yAxis: "6.5",
        message:
          "The Meryln locator needed a new layout. The muted colors pallete was modern, yet classy, further afirming the brands identity as a high end retailer. ",
      },
      {
        ...
        yAxis: "80",
        message:
          "The current location point is customised to follow the color scheme of the Merlyn locator",
      },
      {
    ...
    digitalHub: [
      {
        ...
        yAxis: "5",
        message:
          "The Digital Hub has a skilled, engaged userbase so keeping up with the latest web trends was important. The header uses a background video to set the tone of a productive, innovitave website.",
      },
      {
        title: "Parallax",
        xAxis: "16",
        yAxis: "18",
        message:
          "The Digital Hub website uses parallax. When scrolling, the elements of the page scroll along with it. ",
      },
      {
        title: "Masonary Grid",
        xAxis: "6.5",
        yAxis: "47",
        message:
          "A bespoke masonary grid, the grid allows for different categories to be displayed depending on a series of different criteria all defined by the Digital Hub in their backend. It allows them to feature jobs, news, events, and social media posts.",
      },
      {
        title: "Members area",
        xAxis: "92",
        yAxis: "1.5",
        message:
          "The members area is what I was responsible for developing. Only acessable by members of the digital hub community, so unfortunatly can't be shown to you but trust me it was nice :).",
      },
    ],
    wellman: [
      {
        ...
        yAxis: "1",
        message:
          "A fixed header means that the user always has rapid access to other pages.",
      },
      {
        title: "clean layout",
        xAxis: "5",
        yAxis: "33.5",
        message:
          "A clean layout coupled with a stylish use of color, strong typography, and good imagery made it a pleasure to implement.",
      },
      {
        title: "Image Mapper",
        xAxis: "5",
        yAxis: "60.5",
        message:
          "A nice piece of functionality, the image mapper was the inspiration for the one on this site. The original was a php implementation with a series of configurables. My own is a pure Javascript implementation, with my own customisations",
      },
    ],
  };
  ...
  document
    .querySelectorAll(".component-map-banner")
    .forEach(function (elem, index) {
...
function checkForMatchingColors(element, colorType, changeToColor, firstColor) {
  ...
  var backgroundElement = document.elementFromPoint(
    rect.left - 1,
    rect.top - 1
  );
  var bgElemColor = window
